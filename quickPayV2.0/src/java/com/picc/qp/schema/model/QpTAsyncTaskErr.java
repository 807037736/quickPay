...
@Entity
@Table(name = "qp_t_async_task_err")
public class QpTAsyncTaskErr implements java.io.Serializable{
	private static final long serialVersionUID = 1L;
	
	/**	构造函数	**/
	public QpTAsyncTaskErr() {
	}
	
	/** 主键对象 **/
	private QpTAsyncTaskErrId id;
	
    @EmbeddedId
    @AttributeOverrides( {
      @AttributeOverride(name = "taskId", column = @Column(name = "taskId"))
    })
	public QpTAsyncTaskErrId getId() {
		return this.id;
	}

	public void setId(QpTAsyncTaskErrId id) {
