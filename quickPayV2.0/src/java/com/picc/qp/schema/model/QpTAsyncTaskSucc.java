...
@Entity
@Table(name = "qp_t_async_task_succ")
public class QpTAsyncTaskSucc implements java.io.Serializable{
	private static final long serialVersionUID = 1L;
	
	/**	构造函数	**/
	public QpTAsyncTaskSucc() {
	}
	
	/** 主键对象 **/
	private QpTAsyncTaskSuccId id;
	
    @EmbeddedId
    @AttributeOverrides( {
      @AttributeOverride(name = "taskId", column = @Column(name = "taskId"))
    })
	public QpTAsyncTaskSuccId getId() {
		return this.id;
	}

	public void setId(QpTAsyncTaskSuccId id) {
