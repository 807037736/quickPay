...
public abstract class ItemTag extends TagSupport {
	...
	public void setId(String id) {
		...
		if (id != null && id.startsWith("${") && id.endsWith("}")) {
			try {
				this.id = (String) ExpressionEvaluatorManager.evaluate("id", id, Object.class, this, pageContext);
	...
	public void setAccesskey(String accesskey) throws JspException {
		...
		if (accesskey != null && accesskey.startsWith("${") && accesskey.endsWith("}")) {
			this.accesskey = (String) ExpressionEvaluatorManager.evaluate("accesskey", accesskey, Object.class, this,
					pageContext);
		}
	};
	...
	public void setCssClass(String cssClass) throws JspException {
		...
		if (cssClass != null && cssClass.startsWith("${") && cssClass.endsWith("}")) {
			this.cssClass = (String) ExpressionEvaluatorManager.evaluate("cssClass", cssClass, Object.class, this,
					pageContext);
		}
	};
	...
	public void setCssStyle(String cssStyle) throws JspException {
		...
		if (cssStyle != null && cssStyle.startsWith("${") && cssStyle.endsWith("}")) {
			this.cssStyle = (String) ExpressionEvaluatorManager.evaluate("cssStyle", cssStyle, Object.class, this,
					pageContext);
		}
	};
	...
	public void setDisabled(String disabled) throws JspException {
		...
		if (disabled != null && disabled.startsWith("${") && disabled.endsWith("}")) {
			this.disabled = (String) ExpressionEvaluatorManager.evaluate("disabled", disabled, Object.class, this,
					pageContext);
		}
	};
	
	public void setEditable(String editable) throws JspException {
		this.editable = editable;
		if (editable != null && editable.startsWith("${") && editable.endsWith("}")) {
			this.editable = (String) ExpressionEvaluatorManager.evaluate("editable", editable, Object.class, this,
					pageContext);
		}
	};
	...
	public void setName(String name) throws JspException {
		...
		if (name != null && name.startsWith("${") && name.endsWith("}")) {
			this.name = (String) ExpressionEvaluatorManager.evaluate("name", name, Object.class, this, pageContext);
		}
	};
	...
	public void setOnblur(String onblur) throws JspException {
		...
		if (onblur != null && onblur.startsWith("${") && onblur.endsWith("}")) {
			this.onblur = (String) ExpressionEvaluatorManager.evaluate("onblur", onblur, Object.class, this,
					pageContext);
		}
	};
	...
	public void setOnchange(String onchange) throws JspException {
		...
		if (onchange != null && onchange.startsWith("${") && onchange.endsWith("}")) {
			this.onchange = (String) ExpressionEvaluatorManager.evaluate("onchange", onchange, Object.class, this,
					pageContext);
		}
	};
	...
	public void setOnclick(String onclick) throws JspException {
		...
		if (onclick != null && onclick.startsWith("${") && onclick.endsWith("}")) {
			this.onclick = (String) ExpressionEvaluatorManager.evaluate("onclick", onclick, Object.class, this,
					pageContext);
		}
	};
	...
	public void setOndblclick(String ondblclick) throws JspException {
		...
		if (ondblclick != null && ondblclick.startsWith("${") && ondblclick.endsWith("}")) {
			this.ondblclick = (String) ExpressionEvaluatorManager.evaluate("ondblclick", ondblclick, Object.class,
					this, pageContext);
		}
	};
	...
	public void setOnfocus(String onfocus) throws JspException {
		...
		if (onfocus != null && onfocus.startsWith("${") && onfocus.endsWith("}")) {
			this.onfocus = (String) ExpressionEvaluatorManager.evaluate("onfocus", onfocus, Object.class, this,
					pageContext);
		}
	};
	...
	public void setOnkeydown(String onkeydown) throws JspException {
		...
		if (onkeydown != null && onkeydown.startsWith("${") && onkeydown.endsWith("}")) {
			this.onkeydown = (String) ExpressionEvaluatorManager.evaluate("onkeydown", onkeydown, Object.class, this,
					pageContext);
		}
	};
	...
	public void setOnkeypress(String onkeypress) throws JspException {
		...
		if (onkeypress != null && onkeypress.startsWith("${") && onkeypress.endsWith("}")) {
			this.onkeypress = (String) ExpressionEvaluatorManager.evaluate("onkeypress", onkeypress, Object.class,
					this, pageContext);
		}
	};
	...
	public void setOnkeyup(String onkeyup) throws JspException {
		...
		if (onkeyup != null && onkeyup.startsWith("${") && onkeyup.endsWith("}")) {
			this.onkeyup = (String) ExpressionEvaluatorManager.evaluate("onkeyup", onkeyup, Object.class, this,
					pageContext);
		}
	};
	...
	public void setOnmousedown(String onmousedown) throws JspException {
		...
		if (onmousedown != null && onmousedown.startsWith("${") && onmousedown.endsWith("}")) {
			this.onmousedown = (String) ExpressionEvaluatorManager.evaluate("onmousedown", onmousedown, Object.class,
					this, pageContext);
		}
	};
	...
	public void setOnmousemove(String onmousemove) throws JspException {
		...
		if (onmousemove != null && onmousemove.startsWith("${") && onmousemove.endsWith("}")) {
			this.onmousemove = (String) ExpressionEvaluatorManager.evaluate("onmousemove", onmousemove, Object.class,
					this, pageContext);
		}
	};
	...
	public void setOnmouseout(String onmouseout) throws JspException {
		...
		if (onmouseout != null && onmouseout.startsWith("${") && onmouseout.endsWith("}")) {
			this.onmouseout = (String) ExpressionEvaluatorManager.evaluate("onmouseout", onmouseout, Object.class,
					this, pageContext);
		}
	};
	...
	public void setOnmouseover(String onmouseover) throws JspException {
		...
		if (onmouseover != null && onmouseover.startsWith("${") && onmouseover.endsWith("}")) {
			this.onmouseover = (String) ExpressionEvaluatorManager.evaluate("onmouseover", onmouseover, Object.class,
					this, pageContext);
		}
	};
	...
	public void setOnmouseup(String onmouseup) throws JspException {
		...
		if (onmouseup != null && onmouseup.startsWith("${") && onmouseup.endsWith("}")) {
			this.onmouseup = (String) ExpressionEvaluatorManager.evaluate("onmouseup", onmouseup, Object.class, this,
					pageContext);
		}
	};
	...
	public void setOnselect(String onselect) throws JspException {
		...
		if (onselect != null && onselect.startsWith("${") && onselect.endsWith("}")) {
			this.onselect = (String) ExpressionEvaluatorManager.evaluate("onselect", onselect, Object.class, this,
					pageContext);
		}
	};
	...
	public void setRequired(String required) throws JspException {
		...
		if (required != null && required.startsWith("${") && required.endsWith("}")) {
			this.required = (String) ExpressionEvaluatorManager.evaluate("required", required, Object.class, this,
					pageContext);
		}
	};
	...
	public void setSize(String size) throws JspException {
		...
		if (size != null && size.startsWith("${") && size.endsWith("}")) {
			this.size = (String) ExpressionEvaluatorManager.evaluate("size", size, Object.class, this, pageContext);
		}
	};
	...
	public void setTabindex(String tabindex) throws JspException {
		...
		if (tabindex != null && tabindex.startsWith("${") && tabindex.endsWith("}")) {
			this.tabindex = (String) ExpressionEvaluatorManager.evaluate("tabindex", tabindex, Object.class, this,
					pageContext);
		}
	};
	...
	public void setTitle(String title) throws JspException {
		...
		if (title != null && title.startsWith("${") && title.endsWith("}")) {
			this.title = (String) ExpressionEvaluatorManager.evaluate("title", title, Object.class, this, pageContext);
		}
	};
	...
	public void setTooltip(String tooltip) throws JspException {
		...
		if (tooltip != null && tooltip.startsWith("${") && tooltip.endsWith("}")) {
			this.tooltip = (String) ExpressionEvaluatorManager.evaluate("tooltip", tooltip, Object.class, this,
					pageContext);
		}
	};
	...
	public void setValue(String value) throws JspException {
		...
		if (value != null && value.startsWith("${") && value.endsWith("}")) {
			this.value = (String) ExpressionEvaluatorManager.evaluate("value", value, Object.class, this, pageContext);
		}
	};
