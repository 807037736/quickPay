...
import com.picc.common.service.facade.YpSmsService;
/**
 * 短信http接口的实现类
 ...
 * @since 2015-04-03
 */
@Service("ypSmsService")
public class YpSmsServiceImpl implements YpSmsService {
    ...
    public String sendOperation(String text,String mobile) throws IOException, URISyntaxException {
        ...
        String apikey = "4b1fc9c24e86aeecff74b87b1da750d0 ";
        //修改为您要发送的手机号
        //String mobile = "18200980043";
        ...
        //发短信调用示例
        return  sendSms(apikey, text, mobile).toString();
