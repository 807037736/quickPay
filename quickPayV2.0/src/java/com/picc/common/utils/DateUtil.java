...
import com.picc.common.utils.consts.RegexStrings;
...
public class DateUtil {	
	...
	public static final String SIMPLE_DATE_HAO_STR = "yyyy年MM月dd号";
	public static final String SIMPLE_DATE_RI_STR = "yyyy年MM月dd日";
	...
	* @author luguosui
	 ...
	 * @throws ParseException
	 */
	public static String parseToFormatString(String dateStr,String formatStr) throws ParseException{
		if(StringUtils.isEmptyStr(dateStr)||StringUtils.isEmptyStr(formatStr)){
    		return null;
    	}
	...
	/**
	 * 时起保时间(即时起保 到 小时数),默认传统起保,取第二天0:00:00
	 * @return
	 */
	...
	/**
	 * 终保时间,包括即时起保,终保时间都是24:00:00 (Date 没有24:00:00,所以一般保存为23:59:59 999)
	 * @param startDate
	 * @return
	 */
