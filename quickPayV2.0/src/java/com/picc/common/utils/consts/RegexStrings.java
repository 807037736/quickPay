package com.picc.common.utils.consts;
...
public class RegexStrings {
    ...
    //交强险标志
    public static final String ACCIDENT_RISK = "2";
    //商业险标志
    public static final String BUSINESS_RISK = "1";
    //保单信息查询返回代码
    public static final String QUERY_POLICY_RETURN_CODE = "000";
    //保单信息查询返回错误代码
    public static final String QUERY_POLICY_ERROR_CODE = "999";
    //支付类型
    // 1 支付宝支付
    public static final String PAY_METHOD_1 = "1";
    // 2 快钱支付
    public static final String PAY_METHOD_2 = "2";
