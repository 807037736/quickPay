...
public class CRNConnect{
	...
	private static final Logger logger = LoggerFactory.getLogger(CRNConnect.class);

	// Set the location of the sample reports.
	/*
	 * private String curDir = System.getProperty("user.dir"); private String
	 * CRN_HOME = curDir.substring(0,curDir.lastIndexOf("sdk")-1); private
	 * String REPORT_PATH = CRN_HOME + "/webcontent/samples";
	 */
	...
	public static String CM_URL = BIConfig.getCognosURL();
	...
	public ContentManagerService_PortType connectToCognosServer() {
		...
		while (bibus == null) {
			...
			try {
				...
				logger.error("Unable to connect at the URL: " + CM_URL + ". Please make sure the service is running.");
				return null;
			}
			...
			logger.error("Connect Failed. Try again.");
		}
		return null;
	}
	...
	public ContentManagerService_PortType connectionChange(String endPoint) {
		try {
			...
			logger.error(eService.getMessage());
			return null;
		}
	}

	/*
	 * public String getDefaultSavePath() { return REPORT_PATH; }
	 * 
	 * public void setDefaultSavePath(String newReportPath) { REPORT_PATH =
	 * newReportPath; }
	 */
