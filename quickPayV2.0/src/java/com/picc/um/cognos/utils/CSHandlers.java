...
{
	private static final Logger logger = LoggerFactory.getLogger(CSHandlers.class);
		...
		String targetPath)
	{
		...
		////System.out.println("");
		logger.info("Here is the list of items that were moved.");
		if (obj != null)
		{
			for (int i = 0; i < obj.length; i++)
			{
				logger.info("Name:" + obj[i].getDefaultName().getValue());
			}
		}
		else
		{
			logger.info("No items were moved.");
		}
	}
		...
		String targetPath)
	{
		...
		if (obj != null)
		{
			logger.info("Here is the list of items that were copied.");
			for (int i = 0; i < obj.length; i++)
			{
				logger.info("Name:" + obj[i].getDefaultName().getValue());
			}
		...
		{
			logger.info("No items were copied.");
			return false;
		}
	}
	...
	{
		Account me = Logon.getLoggeronAccount(connection);
