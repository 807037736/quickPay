...
Jh.fn = function(a) {
  return a = {
    ...
    _createLis: function(b, c) {
      $.each(b,
      function(b, d) {
        c.append(a._createLi(b, d.title));
      });
    },
    _createA: function(a) {
...
Jh.Portal = function(a) {
  ...
  return a = {
    ...
    _createPortalOne: function(b, c) {
      var e = a._createItemHeader(c.title),
      f = a._createItemContent(c.url);
    ...
    _createItemContent: function(b) {
      var a = $(i);
     // $("<ul style='width:250px;'><li><a href='http://www.baidu.com'>百度</li><li>xiaofanV587</li><li>xiaofanV587</li><li>xiaofanV587</li><li>xiaofanV587</li></ul>").appendTo(a);
	 $("<iframe src='"+b+"' FrameBorder='0' scrolling='no'>" ).appendTo(a);
      return a;
    },
...
function savePortletRight(d){
	...
	/*$.post(
		contextRootPath + "/portal/savePortletPosition.do",
		{a:d,porletcol:"appR"}
	);*/
};
...
function findWfTPortlettemplate(){
...
function saveLayout(f){
	...
	/*$.post(
		contextRootPath + "/portal/saveTemplateCode.do",
		{templateCode:f}
	);*/
}