	...
	<div id="todayList">
		<ul class="todayList" style="margin-left: 0px;padding-left: 0px;">
			<li class="only4" style="padding: 10px 0 0 0"><a
				href="javascript:alert('囧漫创作中，欢迎提供稿件')">
					<div class="img">
						<img src="../image/sv01.png" />
					</div>
					<h2>保险囧漫</h2>
					<p class="onlyheight">漫漫告诉你人保能做啥</p> <span class="icon">&nbsp;</span>
					<div class="clr"></div>
			</a></li>
			<li class="only4" style="padding: 10px 0 0 0"><a
				href="${ctx }/pages/main/anli.jsp?param=<%=request.getParameter("param")%>">
					<div class="img">
						<img src="../image/sv02.png" />
					</div>
					<h2>保险案例</h2>
					<p class="onlyheight">不知道保险怎么用，看这里</p> <span class="icon">&nbsp;</span>
					<div class="clr"></div>
			</a></li>
			<li class="only4" style="padding: 10px 0 0 0"><a
				href="${ctx }/pages/main/zhishi.jsp?param=<%=request.getParameter("param")%>">
					<div class="img">
						<img src="../image/sv03.png" />
					</div>
					<h2>保险知识</h2>
					<p class="onlyheight">书中自有黄金屋，书中自有颜如玉</p> <span class="icon">&nbsp;</span>
					<div class="clr"></div>
			</a></li>
