...
<form name="fm"  method="post" id="fm">
	<div class="toolBar"><a href="javascript:goback()" class="back"></a>${title }</div>
	<br>
	<div class="main">
		 <div class="warm">
    		<p class="warm_ico ta_c"><i class="i-ok"></i><strong class="wran_font">${butMsg }</strong></p>
  		</div>			
	</div>
	<div class="in_div" style="margin-top:10px; margin-bottom:0px;">
