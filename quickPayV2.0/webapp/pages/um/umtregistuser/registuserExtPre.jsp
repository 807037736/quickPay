...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		...
		<input type="hidden" id="username" name="username" value="${umTRegistuser.userName}" />
		<input type="hidden" id="usercode" name="usercode" value="${umTRegistuser.id.userCode}" />
		<input type="hidden" id="mobileno" name="mobileno" value="${umTRegistuser.mobile}" />
			...
			<div class="form-group">
				<input type="text" name="licenseno" id="licenseno" class="form-control input-lg  v_name" placeholder="车牌" tabindex="4">
			</div>
			
			<div class="form-group">
				<input type="text" name="identifyno" id="identifyno" class="form-control input-lg v_phoneNo" placeholder="被保险人身份证" tabindex="4">
			</div>
