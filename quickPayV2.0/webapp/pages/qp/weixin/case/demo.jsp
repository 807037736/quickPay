...
<head>
  ...
  <link href="${ctx }/pages/qp/weixin/resources/css/style.css" rel="stylesheet" >
</head>
<body ontouchstart="">
...
<script src="${ctx }/pages/qp/weixin/resources/js/jweixin-1.0.0.js"></script>
<script>
  /*
   * 注意：
...
// 			appSecret : '0c4bb6b13470ce5f6191bfd391048992',
  ...
  wx.config({
      debug: false,
      appId: 'wxb620b2136e9f110e',
      timestamp: 1469497327,
      nonceStr: 'D1X3lDPE5lRp0puE',
      signature: '0920e230654dcb8b1214413b0eedddd02180ad2d',
      jsApiList: [
        'checkJsApi',
        'onMenuShareTimeline',
        'onMenuShareAppMessage',
...
<script src="${ctx }/pages/qp/weixin/resources/js/zepto.min.js"></script>
<script src="${ctx }/pages/qp/weixin/resources/js/demo.js"> </script>
</html>
