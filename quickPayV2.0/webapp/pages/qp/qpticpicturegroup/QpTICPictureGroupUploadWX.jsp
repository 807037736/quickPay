			...
			<div class="wxapi_container">
				<div id="item1" class="mui-control-content mui-active">
					<form action="kckpyw_submitPhoto_subInfo.action" method="post" id="subform">
						<input type="hidden" name="groupId" value="${accidentGroupId}" id="groupId">
						<div class="mui-content-padded">
							<h5>第一步：从车头方向45度角拍摄</h5>
						...
						<br>
						<br> <a href="${ctx }/weixin/case/carRemind.do"
					...
					success : function(res) {
						...
						wx
								.uploadImage({//选择图片后自动上传到微信服务端
									...
									$.ajax({
													url : '${ctx}/qp/qpticpicturegroup/getPictureWeixin.do',
													type : 'POST',
													data : {
					...
					function() {
						...
						if ($("#servId1").val() == null
							...
							$
									.ajax({
										async : false,
										url : '${ctx}/qp/qpticpicturegroup/updatePictureGroup.do',
										type : 'POST',
										data : {
											groupId : $('#groupId').val()
										},
										...
										success : function(data) {
											if (data.code == -1) {
												...
												location.href = '${ctx}/qp/qpticpicturegroup/prepareQuery.do';
											}
										},
										error : function(data) {
											showTips("上传失败", 1000);
							...
							// 	$("#subform").attr("action",contextRootPath+"/qp/qpticpicturegroup/prepareQuery.do");
							// $("#subform").submit();
