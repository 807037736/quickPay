...
function toQueryOthcampusNo(){
	editRecord(contextRootPath+'/syn/othcampus/toQueryOthcampusNo.do');
}
				...
				<div class="content">
					<div class="enter">
						...
						<div class="code">
							...
							<!--<a>&nbsp;|&nbsp;</a>
							 <a href="#" onclick="toQueryOthcampusNo()">查询学校代码</a> -->
						</div>
						
              <a id="loginEnter" href="javascript:void(0)" onclick="javascript:fsubmit(document.fm);" title="登录" class="login_a" > 登录 </a>
			  			<!-- 
